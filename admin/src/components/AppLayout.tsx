...
const sections: ReadonlyArray<readonly [heading: string, links: readonly NavEntry[]]> = [
  ...
  ["Operaciones", [["fulfillments", "Entregas", PackageCheck], ["sales-automation", "Ventas por WhatsApp", Settings]]],
  ["Proveedores", [["provider-services", "Catálogo de proveedores", Boxes], ["mappings", "Vínculos de entrega", Layers3]]],
  ["", [["integrations", "Integraciones", PlugZap], ["api-credentials", "Credenciales API", KeyRound], ["settings", "Configuración", Settings]]],
];
