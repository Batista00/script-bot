...
export function validateTypebotDocument(template) {
  ...
  // Contrato mínimo de runtime: solo lo que el flujo realmente lee.
  // Evolution aporta `remoteJid` y `pushName`; el publicador inyecta
  // `backend_base_url` y `backend_token`.
